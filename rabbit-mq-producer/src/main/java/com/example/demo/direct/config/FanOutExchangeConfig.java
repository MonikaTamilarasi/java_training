...
public class FanOutExchangeConfig {
	...
	public Queue fanOutQueue1() {
		return new Queue("ccet.ece.student",false);
	}
	
	@Bean
	public Queue fanOutQueue2() {
		return new Queue("ccet.cse.student",false);
	}
	
	@Bean
	public FanoutExchange exchange() {
		return new FanoutExchange("CCET");
	}
	
	@Bean
    public Binding binding1(FanoutExchange exchange, @Qualifier("fanOutQueue1")
    Queue fanoutQueue1) {
